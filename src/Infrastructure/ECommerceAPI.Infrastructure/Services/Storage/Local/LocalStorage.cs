...
public class LocalStorage : ILocalStorage
{
    ...
    public async Task<List<(string fileName, string pathOrContainerName)>> UploadAsync(string path, IFormFile[] files)
    {
        ...
        {
            string fileNewName = file.FileRename(path, HasFile);
